...
void Terra::update() { m_sensorController->update(); }
...
// getFullStringFromJson}; static EndpointMapping sSensorPage = {"/sensors",
// "application/json", jsonSensorsFormatter.getStringFromJson}; static
// EndpointMapping sClockPage = {"/clock", "application/json",
// jsonClockFormatter.getStringFromJson}; static EndpointMapping sHumidityPage =
// {"/humidity_calendar", "application/json",
// jsonHumidityCalendarFormatter.getStringFromJson}; static EndpointMapping
// sLightPage = {"/light_calendar", "application/json",
// jsonLightCalendarFormatter.getStringFromJson};
